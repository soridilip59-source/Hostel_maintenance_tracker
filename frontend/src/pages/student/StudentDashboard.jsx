...
function StudentDashboard() {
  ...
  return <>
    <div className="page-header"><div><p className="eyebrow">Home / Dashboard</p><h1>Good {new Date().getHours() < 12 ? "morning" : new Date().getHours() < 18 ? "afternoon" : "evening"}, {user.name || "Student"} 👋</h1><p className="subtitle">Here's a clear overview of your room and maintenance requests.</p></div><Link className="button-primary" to="/student/report">+ Report an issue</Link></div>
